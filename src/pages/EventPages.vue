...
<template>
  <div class="bg-gradient-to-bpx-4 min-h-screen px-4 py-8 pt-24">
    ...
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-12">
          <div class="relative md:col-span-5">
            <input
              ...
              class="w-full rounded-lg border border-purple-300/20 bg-white/5 px-4 py-2.5 text-white placeholder-gray-400 backdrop-blur-xs transition-all focus:border-purple-400 focus:ring-2 focus:ring-purple-400/20 focus:outline-hidden" />
          ...
          <div class="lg:col-span-7">
            <router-link
              ...
              <div
                ...
                <div
                  class="absolute inset-0 bg-linear-to-t from-purple-950/90 via-purple-950/50 to-transparent">
          ...
          <div class="lg:col-span-5">
            <div class="space-y-4">
              <router-link
                ...
                class="group block overflow-hidden rounded-xl bg-white/5 p-4 backdrop-blur-xs transition-all hover:bg-white/10">
      ...
      <div
        v-if="!hasResults"
        class="flex min-h-[300px] items-center justify-center rounded-xl bg-white/5 backdrop-blur-xs">

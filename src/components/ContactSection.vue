...
const MessageToWhatsapp = () => {
  ...
  const phoneNumber = '+6282124681113'
        ...
        >
          ...
          <form @submit.prevent="MessageToWhatsapp">
            ...
            <div class="mt-4 grid">
              <button
                type="submit"
                class="inline-flex items-center justify-center gap-2 rounded-2xl border border-transparent bg-green-500 px-4 py-3 text-sm font-semibold text-white transition-all hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-neutral-900"
              >

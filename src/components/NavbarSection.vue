  ...
  <nav
    ...
    <div class="mx-auto flex items-center justify-between px-5 py-3">
      ...
      <div
        ...
        <ul class="block items-center gap-0 text-white lg:flex lg:py-0">
          <!-- Regular Nav Items -->
          <li
            ...
            <a
              ...
              class="nav-link block cursor-pointer px-4 font-semibold focus:text-slate-400">
              {{ item.name }}
            </a>
          </li>
          <!-- Dropdown Menu -->
...
<style scoped>
  ...
  .nav-link:after {
    display: block;
    content: '';
    border-bottom: solid 3px #fbb2dd;
    transform: scaleX(0);

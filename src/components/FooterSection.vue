<template>
  ...
  >
    ...
    <div class="mb-10 grid grid-cols-2 gap-6 md:grid-cols-4 lg:grid-cols-5">
      ...
      <div>
        <h4
          class="text-xs font-semibold uppercase text-gray-900 dark:text-neutral-100"
        >
          Product
        </h4>
        ...
        <div class="mt-3 grid space-y-3 text-sm">
          <p>
            <a
              class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 focus:text-gray-800 focus:outline-none dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
              href="#"
              >Pricing</a
            >
          </p>
      ...
      <div>
        ...
        <h4
          class="mt-7 text-xs font-semibold uppercase text-gray-900 dark:text-neutral-100"
        >
          Industries
        </h4>
    ...
    <div class="mt-5 border-t border-gray-200 pt-5 dark:border-neutral-700">
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex flex-wrap items-center justify-between gap-3">
          ...
          <div class="space-x-4">
            <a
              class="inline-block text-gray-500 hover:text-gray-800 focus:text-gray-800 focus:outline-none dark:text-neutral-500 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
              href="#"
            >
              <svg
